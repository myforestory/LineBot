...
//	private String accessToken = "uN4Adp2siY1bd4k2vcCzyN9wKGkHTONWuHmNAk+TcQE3GkKhUkOKab9CmbVNiV+K+bsDgqtq78ApPUfAq8b6RWYl1SBHrhnVNbvg37FQSaH4UAR51RGGNM+PouklBcquzR8wkeuAd0m5LppYZGtAdwdB04t89/1O/w1cDnyilFU=";
	...
	private void typeIsError(String replyToken, int respCode) {
		String errorTemplate ="";
		if(respCode != 200){
			errorTemplate = MessageTemplate.textMessage(
					"再輸入一次好嗎"
			);
			sendResponseError(replyToken, errorTemplate);
		}
	}
	...
	protected void sendResponseMessages(String replyToken, String message) {
		...
		try {
			...
			typeIsError(replyToken, con.getResponseCode());
	...
	protected void sendResponseError(String replyToken, String message) {
//		System.out.println(message);
//		
//		try {
//			
